...
public class UserServlet extends HttpServlet {
    ...
    private void listUserSearch(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<User> listKeyword = userDAO.selectAllByKeyWord(keyword);
        request.setAttribute("listUser", listKeyword);
    ...
    private void sortByNameAsc(HttpServletRequest request, HttpServletResponse response) {
        List<User> listSort = userDAO.sortByNameAsc();
    ...
    private void sortByNameDesc(HttpServletRequest request, HttpServletResponse response) {
        List<User> listSort = userDAO.sortByNameDesc();
        request.setAttribute("listUser", listSort);
        RequestDispatcher dispatcher = request.getRequestDispatcher("view/user/list.jsp");
        try {
            dispatcher.forward(request, response);
